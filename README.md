...
3. Provides two-way binding for controls and attributes
4. Provides a template with bindings for attributes, properties, CSS custom properties, and CSS shadow parts.
