...
export class MyElement extends LitElement {
  ...
  render() {
    return html`
      <div class="card">
        <div>
          <a href="https://storybook.js.org/docs/get-started/web-components-vite" target="_blank">
  ...
  static styles = css`
    ...
    .card {
      padding: 2em;
      border: var(--card-border-color) var(--card-border-size) var(--card-border-style);
